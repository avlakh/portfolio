    ...
    <section id="projects">
        <div class="container">
            ...
            <div class="projects-grid">
                <div class="projects-grid-item" v-for="item in projects" :key="item">
                    <div class="img-wrap">
                        <img :src="require('@/assets/images/projects/'+item.img)" :alt="item.imgAlt">
                    </div>
                    <div class="content-overlay">
                        <div class="content-overlay-links">
                            <a :href="item.githubUrl" target="_blank">See source code</a>
...
.projects-grid {
    ...
    height: 100%;
    display: grid;
    grid-template: repeat(auto-fit, minmax(150px, 1fr)) / repeat(auto-fit, minmax(300px, 1fr));
    gap: 3rem;
}
...
@media screen and (min-width: 700px){
    .projects-grid {
        grid-template: repeat(auto-fit, minmax(300px, 1fr)) / repeat(auto-fit, minmax(450px, 1fr));
    }
}
